...
for(let i = 0; i < dom_moles.length; i++){
    ...
    // console.log(i);
    // moles.puch(new mole(dom_moles[i]));
    
}

for(let i = 0; i < dom_moles.length; i++){
    moles[i].getDOM.onclick = function(){
        console.log('クリックされました');
        //ここになんか処理内容を書く
        //このオブジェクト（もぐら）をクリックしたときに非表示にする
        moles[i].defeated();
    }
    //addeventlistenerでもいける

    // console.log(moles[i]);
}
// for(let i = 0; i < 12000; i++){
//     console.log(moles[0].timer);
// }